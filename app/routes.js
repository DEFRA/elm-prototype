...
router.post('/actions-answer', function (req, res) {
  ...
  if (action == "cover-crops"){res.redirect('/tier1-v2/actions-answers?cover-crops[selected]=true')}
  if (action == "create-grassland"){res.redirect('/tier1-v2/options/create-grassland')}
  if (action == "deadwood"){res.redirect('/tier1-v2/actions-answers?deadwood[selected]=true')}
  ...
  if (action == "fertilisers"){res.redirect('/tier1-v2/actions-answers?fertilisers[selected]=true')}
  ...
  if (action == "manure"){res.redirect('/tier1-v2/actions-answers?manure[selected]=true')}
...
router.post('/actions-answer-1', function (req, res) {
  ...
  if (action == "agroforestry"){res.redirect('/tier1-v1-guidance/agroforestry')}
  if (action == "bare-soil"){res.redirect('/tier1-v1-guidance/bare-soil')}
  if (action == "bog-grazing"){res.redirect('/tier1-v1-guidance/bog-grazing')}
  if (action == "canopy-cover"){res.redirect('/tier1-v1-guidance/canopy-cover')}
  if (action == "cover-crops"){res.redirect('/tier1-v1-guidance/cover-crops')}
  if (action == "create-grassland"){res.redirect('/tier1-v1-guidance/create-grassland')}
  if (action == "deadwood"){res.redirect('/tier1-v1-guidance/deadwood')}
  if (action == "drinking-water"){res.redirect('/tier1-v1-guidance/drinking-water')}
  if (action == "fencing"){res.redirect('/tier1-v1-guidance/fencing')}
  if (action == "fertilisers"){res.redirect('/tier1-v1-guidance/fertilisers')}
  if (action == "fertiliser-spreading"){res.redirect('/tier1-v1-guidance/fertiliser-spreading')}
  if (action == "flower-habitat"){res.redirect('/tier1-v1-guidance/flower-habitat')}
  if (action == "grass-strips"){res.redirect('/tier1-v1-guidance/grass-strips')}
  if (action == "manure"){res.redirect('/tier1-v1-guidance/manure')}
  if (action == "no-till"){res.redirect('/tier1-v1-guidance/no-till')}
  if (action == "nutrients"){res.redirect('/tier1-v1-guidance/nutrients')}
  if (action == "tree-belts"){res.redirect('/tier1-v1-guidance/tree-belts')}
  else {res.redirect('/tier1-v1-guidance/wind-erosion')}
})
...
router.post('/site-visit-required', function (req, res) {
  ...
  if (canopyCover != 0){res.redirect('/tier1-v1-guidance/site-visit')}
  if (deadWood != 0){res.redirect('/tier1-v1-guidance/site-visit')}
  if (agroForestry != 0){res.redirect('/tier1-v1-guidance/site-visit')}
  if (treeBelts != 0){res.redirect('/tier1-v1-guidance/site-visit')}
  else {res.redirect('/tier1-v1-guidance/calculation')}
})
...
router.post('/application-complete', function (req, res) {
  ...
  if (canopyCover != 0){res.redirect('/tier1-v1-guidance/completing-your-application')}
  if (deadWood != 0){res.redirect('/tier1-v1-guidance/completing-your-application')}
  if (agroForestry != 0){res.redirect('/tier1-v1-guidance/completing-your-application')}
  if (treeBelts != 0){res.redirect('/tier1-v1-guidance/completing-your-application')}
  else {res.redirect('/tier1-v1-guidance/agreement-confirmation')}
})
